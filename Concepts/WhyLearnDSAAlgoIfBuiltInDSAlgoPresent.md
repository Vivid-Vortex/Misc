...
---
## What is mean by "There are scenarios where built-in implementations don’t meet your requirements. " can you give some example questions which can't be solved with built in java colloections.
