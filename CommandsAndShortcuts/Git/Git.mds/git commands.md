...
#At last simply run 
git log --oneline
#To see only your logs. first-parent will show you only your and your branch commit excluding other branches. This could be quite useful in case if you want to cherry-pick or something.
