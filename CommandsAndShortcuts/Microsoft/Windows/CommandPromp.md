...
kill any windows tasks which is occuping the required port:
1. netstat -ano | findstr :2181 #It will give you 5 column data including processId at the last column.
